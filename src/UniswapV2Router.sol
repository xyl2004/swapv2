...
contract UniswapV2Router {
    ...
    if (reserveA == 0 && reserveB == 0) {
        // 添加首次添加时的最小量检查
        require(amountADesired >= amountAMin, "UniswapV2Router: INSUFFICIENT_A_MIN");
        require(amountBDesired >= amountBMin, "UniswapV2Router: INSUFFICIENT_B_MIN");
        ...
        if (amountBOptimal <= amountBDesired) {
            ...
            require(amountAOptimal <= amountADesired, "UniswapV2Router: EXCESSIVE_A_AMOUNT"); // 替换 assert
